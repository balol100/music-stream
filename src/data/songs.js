...
export const SONGS = [
  ...
  { id: "XHdb6YDvHII", title: "פגישה לאין קץ", artist: "אריק איינשטיין", year: 1972, era: "israeli", mood: "קלאסיקה" },
  ...
  { id: "J-RdskDt93w", title: "17 בנות", artist: "עברי לידר ומכלוף", year: 2019, era: "israeli", mood: "פופ" },
  { id: "YItjK6Nmvjw", title: "תעצרו את העולם", artist: "עברי לידר", year: 2008, era: "israeli", mood: "פופ" },
  { id: "EQUKVBWFmuI", title: "אביב", artist: "עברי לידר", year: 2010, era: "israeli", mood: "פופ" },
  ...
  { id: "xFrGuyw1V8s", title: "Dancing Queen", artist: "ABBA", year: 1976, era: "60s-70s", mood: "דיסקו" },
  ...
  { id: "yKNxeF4KMsY", title: "Yellow", artist: "Coldplay", year: 2000, era: "2000s", mood: "פופ־רוק" },
  ...
  // ---- 2010s ----
  { id: "OPf0YbXqDm0", title: "Uptown Funk", artist: "Mark Ronson ft. Bruno Mars", year: 2014, era: "2010s", mood: "פאנק" },
  { id: "bim9MeckD-s", title: "Hello", artist: "Adele", year: 2015, era: "2010s", mood: "בלדה" },
  { id: "7wtfhZwyrcc", title: "Believer", artist: "Imagine Dragons", year: 2017, era: "2010s", mood: "פופ־רוק" },
...
export const MOOD_PRESETS = [
  ...
  { id: "chill", emoji: "😌", label: "רגוע", prompt: "מוזיקה רגועה ונעימה להירגע איתה" },
  { id: "workout", emoji: "💪", label: "אנרגטי", prompt: "פלייליסט אנרגטי לאימון או לפתיחת היום" },
  { id: "sad", emoji: "💔", label: "עצוב", prompt: "שירים עצובים ומלאי רגש לרגעים שצריך לשחרר" },
  { id: "romantic", emoji: "🌅", label: "רומנטי", prompt: "פלייליסט רומנטי לערב מיוחד" },
  { id: "focus", emoji: "📚", label: "ריכוז", prompt: "מוזיקה לרקע ללמידה או עבודה — קלילה, בלי הסחות" },
  { id: "roadtrip", emoji: "🚗", label: "נסיעה", prompt: "פלייליסט מושלם לטיול בכביש פתוח" },
